...
const load_rejected =()=>{
	...
	var facility_name = document.getElementById('facility_name_rejected_admin').value;
	...
	$.ajax({
      url: '../../process/admin/rejected.php',
                ...
                cache: false,
                data:{
                    method: 'fetch_rejected',
                    facility_name:facility_name
                },success:function(response){
                   document.getElementById('list_of_rejected_admin').innerHTML = response;
...
document.getElementById('title').innerHTML = "<b>Rejected Items</b>";
}	
